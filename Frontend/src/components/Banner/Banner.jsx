...
function Banner({data}) {
  return (
    <div className='min-h-[450px] flex justify-center py-12'>
        ...
        <div style={{backgroundColor:data.bgColor }}   className='container rounded-3xl' >
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white '>
                    ...
                    <div className='p-6 sm:p-8'>
                        ...
                        {" "}{data.title}</h1>
                        <p data-aos="fade-out"className='text-sm'>{data.date}</p>
                    </div>
                    {/*second col*/}
                    ...
                    <div className='flex flex-col justify-center gap-4 p-6 sm:p-8'>
                        ...
                        <p data-aos="fade-up" className='text-sm traking-wide leading-5'>{data.title4}</p>
                        <div data-aos="fade-up" data-aos-offset="0">
                            <button style={{color:data.bgColor}}className='bg-white text-primery py-2 px-4 rounded-full'>Shop Now</button>
                        </div>
                    </div>
            </div>
        </div>
