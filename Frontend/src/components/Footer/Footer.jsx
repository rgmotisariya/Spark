    ...
    <div>
        <div className="container">
            <div className="grid  md:grid-cols-3 pb-20 pt-5 ">
                ...
                <a href="#" className='text-primary font-semibold tracking-widest text-2xl uppercase sm:text-3xl '>Spark</a>
                ...
                <a href="#" className='inline-block bg-primary/90  mt-4  text-white py-2 px-4  text-sm rounded-full  '>Contact Us</a>
                </div>
